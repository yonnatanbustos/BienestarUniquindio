 ...
 */
class Cliente(var cedula: String, var nombres: String, var apellidos: String, var telefono: String, var email: String, var password: String, var foto: ImageView, var tipoCliente: Tipo, var dependencia: Dependencia) {
